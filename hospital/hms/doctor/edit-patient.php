...
if (isset($_POST['submit'])) {
	...
	$patage = $_POST['patage'];
	$medhis = $_POST['medhis'];
	$sql = mysqli_query($con, "update PatientTbl set PatientName='$patname',PatientContno='$patcontact',PatientEmail='$patemail',PatientGender='$gender',PatientAdd='$pataddress',PatientAge='$patage',PatientMedhis='$medhis' where ID='$eid'");
	if ($sql) {
										...
										<div class="panel panel-white">
											...
											<div class="panel-body">
												<form role="form" name="" method="post">
													<?php
													$eid = $_GET['editid'];
													$ret = mysqli_query($con, "select * from PatientTbl where ID='$eid'");
													$cnt = 1;
