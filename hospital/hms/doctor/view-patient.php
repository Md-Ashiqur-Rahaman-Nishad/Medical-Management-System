...
if (isset($_POST['submit'])) {
  ...
  $query .= mysqli_query($con, "insert   prescriptionHistory(PatientID,BloodPressure,BloodSugar,Weight,Temperature,MedicalPres)value('$vid','$bp','$bs','$weight','$temp','$pres')");
  if ($query) {
          ...
          <div class="container-fluid container-fullw bg-white">
            <div class="row">
              <div class="col-md-12">
                ...
                <?php
                $vid = $_GET['viewid'];
                $ret = mysqli_query($con, "select * from PatientTbl where ID='$vid'");
                $cnt = 1;
                ...
                ?>
                  ...
                  $ret = mysqli_query($con, "select * from prescriptionHistory  where PatientID='$vid'");
