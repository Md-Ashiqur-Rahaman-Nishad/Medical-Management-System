...
if (isset($_POST['submit'])) {
	$sql = mysqli_query($con, "insert into doctorCategory(specilization) values('" . $_POST['doctorCategory'] . "')");
	$_SESSION['msg'] = "Doctor Specialization added successfully !!";
}

if (isset($_GET['del'])) {
	mysqli_query($con, "delete from doctorCategory where id = '" . $_GET['id'] . "'");
											...
											<div class="panel-body">
												...
												<form role="form" name="dcotorspcl" method="post">
													<div class="form-group">
														...
														<input type="text" name="doctorCategory" class="form-control" placeholder="Enter Doctor Specialization">
													</div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<table class="table table-hover" id="sample-table-1">
									...
									<tbody>
										<?php
										$sql = mysqli_query($con, "select * from doctorCategory");
										$cnt = 1;
